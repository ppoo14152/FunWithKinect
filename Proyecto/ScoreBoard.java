...
public class ScoreBoard extends Actor
{
    ...
    private static final Color BACKGROUND_HIGHLIGHT_COLOR = new Color(20, 230, 50, 0xB0);
    ...
    private void drawScores()
    {
        ...
        drawString("Jugadores", 100, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT);
        drawString("Tu puntuación", 100 + getImage().getWidth() / 2, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT);        
